...
class CarFinder:
    ...
    def find_cars(self, img, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins):
...
if __name__ == "__main__":
    ...
    for path in glob.glob('test_images/*.jpg'):
        out_img = find_cars(mpimg.imread(path), classifier.svc, classifier.X_scaler, classifier.orient,
